	...
	void onActivity() {
		...
		if (!inactivityTimer.isShutdown())
			try {
				...
				// surprising, but could be normal if for some reason the implementation
				// just doesn't
				// think it can shcedule again. Since this time-out is non-essential,
				// just forget it
		}
	}
